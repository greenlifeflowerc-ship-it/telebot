...
MSG_IG_EMPTY = (
    "أرجع إنستغرام استجابة فارغة لهذا المنشور:\n"
    "• إذا كان المنشور يُفتح في المتصفح بدون تسجيل دخول، فهي مشكلة مؤقتة "
    "(غالباً حظر مؤقت لعنوان السيرفر). أعد المحاولة لاحقاً، وحدّث yt-dlp بإعادة النشر.\n"
    "• إذا كان لا يُفتح إلا بعد تسجيل الدخول، فهو محتوى خاص/يتطلب حساباً، "
    "ولا يستطيع البوت تنزيله (ينزّل المحتوى العام فقط)."
)
...
_ERROR_RULES: List[tuple] = [
    ...
    # Instagram empty-media: could be transient (public) OR login-gated (private):
    ("empty media response", MSG_IG_EMPTY),
    ("sent an empty media", MSG_IG_EMPTY),
